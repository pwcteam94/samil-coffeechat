...
// 우수 연결 후기 (미팅 후기 쇼케이스) — 운영팀 큐레이션 예시
const TESTIMONIALS = [
  { ju:'윤서진', ju_i:'윤', jc1:'#E8775A', jc2:'#F5A98A',
    se:'박민서', se_i:'박', sc1:'#E8775A', sc2:'#F5A98A', dept:'세무본부 (Tax)',
    topic:'합격 후 입사 전 준비', rating:5,
    quote:'막막하던 공백기에 선배님 한마디가 큰 힘이 됐어요. “완벽하게 준비하기보다 궁금한 걸 메모해 오라”는 조언대로 했더니 입사 첫날이 두렵지 않았어요.' },
  { ju:'강태오', ju_i:'강', jc1:'#5B8DEF', jc2:'#8FB4F7',
    se:'김도윤', se_i:'김', sc1:'#5B8DEF', sc2:'#8FB4F7', dept:'감사1본부 (Audit)',
    topic:'감사 시즌 생존법', rating:5,
    quote:'인차지 선배님이 시즌 루틴을 솔직하게 공유해 주셔서, 막연한 불안이 “해볼 만하다”는 자신감으로 바뀌었습니다.' },
  { ju:'문지아', ju_i:'문', jc1:'#22A98A', jc2:'#5FD3B8',
    se:'이수아', se_i:'이', sc1:'#9B6BD6', sc2:'#C19BEC', dept:'Deals (재무자문)',
    topic:'Deals 본부의 하루', rating:5,
    quote:'숫자 너머의 비즈니스를 보는 눈이 왜 중요한지 알게 됐어요. 커피 한 잔이었는데 커리어 방향이 또렷해졌습니다.' },
  { ju:'배현우', ju_i:'배', jc1:'#9B6BD6', jc2:'#C19BEC',
    se:'정하늘', se_i:'정', sc1:'#22A98A', sc2:'#5FD3B8', dept:'Consulting (Digital)',
    topic:'비전공자의 디지털 직무', rating:4,
    quote:'문과 출신도 데이터 직무에서 잘 적응할 수 있다는 걸 실제 경험으로 들려주셔서 용기를 얻었어요.' },
];

// 동료(동기) 미팅 신청 주제 — 로그인 사용자에게 들어오는 신청
const PEER_TOPICS = [
